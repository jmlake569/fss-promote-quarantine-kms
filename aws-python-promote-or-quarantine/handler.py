...
def copy_object(source_bucket, source_key, dest_bucket, dest_key, tags, metadata, acl=None):
    ...
    metadata['x-amz-server-side-encryption-aws-kms-key-id'] = 'YOUR_KMS_KEY_ID'
    metadata['x-amz-server-side-encryption-context'] = 'YOUR_ENCRYPTION_CONTEXT'

    params['SSEKMSKeyHeader'] = encrypted_key
